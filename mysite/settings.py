...
# Cargar environment variables from .env file 
load_dotenv()
...
INSTALLED_APPS = [
    ...
    "django.contrib.gis",  # <-- necesario para PostGIS
]
...
# Configuración para Render.com (producción)
if not DEBUG:
